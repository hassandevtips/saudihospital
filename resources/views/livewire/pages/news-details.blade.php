                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="video-section" style="margin-top: 30px;">
                                            ...
                                            <div style="max-width: 900px; margin: 0 auto;">
                                                <video controls style="width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);" @if($news->video_thumbnail_url) poster="{{ $news->video_thumbnail_url }}" @endif>
