<div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image_block_one">
                        <div class="image-box mr_30 pr_130 pb_100">
                            ...
                            <figure class="image"><img src="{{ asset('assets/images/resource/about-1.jpg') }}" alt="">
                            </figure>
                    ...
                    <div class="content_block_one">
                        <div class="content-box ml_30">
                            <div class="sec-title left p_relative d_block mb_25">
                                ...
                                <h2>Group Overview<br>Redefining the Future of Healthcare</h2>
                            </div>
                            <div class="text p_relative d_block">
                                <p>Saudi Hospital is a leading private healthcare institution committed to delivering
                                    high-quality, patient-centered medical care across a wide range of specialties.</p>
                            </div>
                            <div class="inner-box">
                                <div class="row clearfix">
    ...
    <section class="chooseus-style-three p_relative" style="margin-top: 80px;">
        ...
        <figure class="image-layer"><img src="{{ asset('assets/images/resource/chooseus-1.png') }}" alt=""></figure>
        <div class="auto-container">
            <div class="row clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 offset-lg-6">
                    <div class="content_block_eight">
                        <div class="content-box p_relative d_block">
                            ...
                            <div class="text p_relative d_block">
                                <h2>Safe, Reliable, and Patient-Centered Medication.</h2>
                                <p>The Pharmacy Department at Alsaudi Hospital is a vital part of our integrated
                                    healthcare system.</p>
                            </div>
                            <div class="inner-box">
                                <div class="row clearfix">
