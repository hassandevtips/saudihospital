        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                ...
                <div class="protein-calculator-wrapper">
                    <h2 style="text-align: center; margin-bottom: 30px; color: #2c3e50;">Protein Calculator</h2>
                    <p style="text-align: center; color: #7f8c8d; margin-bottom: 30px; line-height: 1.6;">
                        The Protein Calculator estimates the daily amount of dietary protein adults require to remain
                        healthy. Modify the values and click the calculate button to use.
                    </p>
                    ...
                    <form id="protein-form">
                            ...
                            <div class="form-row" style="margin-bottom: 20px;">
                                ...
                                <div class="col-md-6" style="padding: 0 10px;">
                                    ...
                                    <input type="number" id="weight-lbs" class="form-control"
                                        placeholder="Weight in pounds" step="0.1" value="165"
                                        style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 5px; font-size: 16px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" style="margin-bottom: 20px;">
                            <div class="col-md-12" style="padding: 0 10px;">
                                ...
                                <select id="activity" class="form-control"
                                    ...
                                    <option value="2.0">Extra Active: very intense exercise daily, or physical job
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row" style="margin-bottom: 20px;">
                            <div class="col-md-12" style="padding: 0 10px;">
                                <label
                                    style="font-weight: 600; color: #2c3e50; margin-bottom: 8px; display: block;">Goal</label>
                    ...
                    <div id="protein-result" style="margin-top: 40px; display: none;">
                        <div style="background: #ecf0f1; padding: 30px; border-radius: 10px;">
                            <h3 style="color: #2c3e50; margin-bottom: 20px; text-align: center;">Your Daily Protein
                                Requirements</h3>
                            ...
                            <div style="text-align: center; margin-bottom: 30px;">
                                ...
                                <div style="font-size: 18px; color: #7f8c8d;">grams of protein per day</div>
                            </div>

                            <!-- Protein Range -->
                            <div
                                style="background: white; padding: 20px; border-radius: 8px; margin-bottom: 20px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                                <h4 style="color: #2c3e50; margin-bottom: 15px; font-size: 18px;">Recommended Range
                                </h4>
                                <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                                    <div style="text-align: center; flex: 1;">
                                        <div style="font-size: 14px; color: #7f8c8d; margin-bottom: 5px;">Minimum</div>
                                        <div id="protein-min"
                                            style="font-size: 24px; font-weight: 600; color: #e74c3c;">
                                        </div>
                                    </div>
                                    <div style="text-align: center; flex: 1;">
                                        <div style="font-size: 14px; color: #7f8c8d; margin-bottom: 5px;">Recommended
                                        </div>
                                        <div id="protein-recommended"
                                            style="font-size: 24px; font-weight: 600; color: #27ae60;"></div>
                                    </div>
                                    <div style="text-align: center; flex: 1;">
                                        <div style="font-size: 14px; color: #7f8c8d; margin-bottom: 5px;">Maximum</div>
                                        <div id="protein-max"
                            ...
                            <div
                                ...
                                <h4 style="color: #2c3e50; margin-bottom: 15px; font-size: 18px;">Additional Information
                                </h4>
                                <div style="margin-bottom: 10px; font-size: 16px; color: #34495e;">
                                    <strong>Your BMR:</strong> <span id="bmr-value"></span> calories/day
                                </div>
                                <div style="margin-bottom: 10px; font-size: 16px; color: #34495e;">
                                    <strong>Daily Calorie Needs:</strong> <span id="tdee-value"></span> calories/day
                                </div>
                                <div style="margin-bottom: 10px; font-size: 16px; color: #34495e;">
                                    <strong>Protein per kg body weight:</strong> <span id="protein-per-kg"></span> g/kg
                                </div>
                                <div style="font-size: 16px; color: #34495e;">
                                    <strong>Protein calories:</strong> <span id="protein-calories"></span> calories/day
                                    (<span id="protein-percentage"></span>% of daily intake)
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 50px;">
                        <h3 style="color: #2c3e50; margin-bottom: 20px;">What are Proteins?</h3>
                        <p style="color: #7f8c8d; line-height: 1.8; margin-bottom: 15px;">
                            Proteins are one of three primary macronutrients that provide energy to the human body,
                            along with fats and carbohydrates. Proteins are also responsible for a large portion of the
                            work that is done in cells; they are necessary for proper structure and function of tissues
                            and organs, and also act to regulate them.
                        </p>
                        <p style="color: #7f8c8d; line-height: 1.8; margin-bottom: 15px;">
                            They are comprised of a number of amino acids that are essential to proper body function,
                            and serve as the building blocks of body tissue. There are 20 different amino acids in
                            total, and the sequence of amino acids determines a protein's structure and function.
                        </p>

                        <h4 style="color: #2c3e50; margin-top: 30px; margin-bottom: 15px;">How Much Protein Do I Need?
                        </h4>
                        <p style="color: #7f8c8d; line-height: 1.8; margin-bottom: 15px;">
                            The amount of protein that the human body requires daily is dependent on many conditions,
                            including overall energy intake, growth of the individual, and physical activity level. The
                            recommended range of protein intake is between 0.8 g/kg and 1.8 g/kg of body weight,
                            dependent on activity level and goals.
                        </p>

                        <h4 style="color: #2c3e50; margin-top: 30px; margin-bottom: 15px;">Recommended Dietary Allowance
                            (RDA)</h4>
                        <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
                            <thead>
                                <tr style="background: #34495e; color: white;">
                                    <th style="padding: 12px; text-align: left; border: 1px solid #ddd;">Age Group</th>
                                    <th style="padding: 12px; text-align: left; border: 1px solid #ddd;">Protein Needed
                                        (grams/day)</th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <h4 style="color: #2c3e50; margin-top: 30px; margin-bottom: 15px;">Foods High in Protein</h4>
                        <p style="color: #7f8c8d; line-height: 1.8; margin-bottom: 15px;">
                            There are many different combinations of food that a person can eat to meet their protein
                            intake requirements. For many people, a large portion of protein intake comes from meat and
                            dairy, though it is possible to get enough protein while meeting certain dietary
                            restrictions.
                        </p>
                        ...
                        <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
                            <thead>
                                <tr style="background: #34495e; color: white;">
                                    ...
                                    <th style="padding: 12px; text-align: left; border: 1px solid #ddd;">Protein Amount
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <div
                            ...
                            <h4 style="color: #0c5460; margin-bottom: 10px;">Important Note</h4>
                            <p style="color: #0c5460; margin: 0; line-height: 1.6;">
                                People who are highly active, or who wish to build more muscle should generally consume
                                more protein. Some sources suggest consuming between 1.8 to 2 g/kg for those who are
                                highly active. Each individual should consult a specialist, be it a dietitian, doctor,
                                or personal trainer, to help determine their individual needs.
                            </p>
                        </div>
                    </div>
                </div>
