    ...
    <section class="news-section p_relative" style="background-color: #f7f8ff; margin-top: 90px;">
        <div class="auto-container">
            <div class="sec-title centred mb_50">
                ...
                <h2 class="text-center">{{ gt('latest_research', 'Latest Research Articles') }}
                </h2>
            </div>
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    ...
                                    <div class="link"><a wire:navigate
                                            href="{{ route('research-details', ['id' => $item->id]) }}">{{ gt('read-more')
                                            }}</a></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    <h3><a href="#">{{ gt('research_article', 'Research Article') }}</a></h3>
                                    <ul class="post-info clearfix">
                                        <li><i class="icon-34"></i>{{ gt('oct_10_2025', '10 Oct, 2025') }}</li>
                                        <li><i class="icon-35"></i><a href="#">{{ gt('admin', 'admin') }}</a></li>
                                    </ul>
                                    <p>{{ gt('research_description', 'Explore our latest research findings and medical innovations.') }}</p>
