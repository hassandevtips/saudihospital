        ...
        <nav class="menu-box">
            ...
            <div class="social-links">
                <ul class="clearfix">
                    ...
                    <li><a href="{{ $settings['twitter'] }}" style="font-weight: bold; font-size: 18px; font-family: Arial, sans-serif;">𝕏</a></li>
                    ...
                    <li><a href="{{ $settings['youtube'] }}"><span class="fab fa-youtube"></span></a></li>
                </ul>
            </div>
        </nav>
    </div><!-- End Mobile Menu -->
